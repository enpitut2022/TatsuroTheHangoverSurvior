...
struct SuggestFoodView: View {
    ...
    let foodText: [[String]] = [
        ["","","","","",""],
        ["龍郎", "なめこの味噌汁", "なめこの味噌汁", "ヨーグルト", "バナナ", "納豆"],
        ["龍郎", "なめこの味噌汁", "なめこの味噌汁", "ヨーグルト", "バナナ", "納豆"],
        ["龍郎", "なめこの味噌汁", "なめこの味噌汁", "ヨーグルト", "バナナ", "納豆"],
        ["脂少なめ龍郎", "なめこの味噌汁", "なめこの味噌汁", "低脂肪ヨーグルト", "バナナ", "納豆"],
        ["脂少なめ龍郎", "なめこの味噌汁", "なめこの味噌汁", "低脂肪ヨーグルト", "バナナ", "納豆"],
        ["野菜少なめ龍郎", "なめこの味噌汁", "なめこの味噌汁", "ヨーグルト", "バナナ", "納豆"],
        ["龍郎", "味噌汁", "なめこの味噌汁", "低脂肪ヨーグルト", "バナナ", "納豆"],
        ["","","","","",""]
    ]
    let foodImage: [String:String] = [
        "龍郎":"tatsuro","脂少なめ龍郎":"tatsuro","野菜少なめ龍郎":"tatsuro",                 "味噌汁":"miso_soup","なめこの味噌汁":"miso_soup","バナナ":"banana", "ヨーグルト":"yogurt",
